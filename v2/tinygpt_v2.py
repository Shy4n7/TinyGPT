...
class TransformerBlock(nn.Module):
    """
    Standard pre-LN Transformer Block for V2.
    """
...
class TinyGPT(nn.Module):
    """
    TinyGPT V2 model (~600k parameters).
    """
    def __init__(self, vocab_size, embedding_dim=128, num_heads=8, num_blocks=4, max_sequence_length=64, hidden_dim=512):
        super().__init__()
    ...
    def forward(self, tokens):
        ...
        assert seq_len <= self.max_sequence_length
