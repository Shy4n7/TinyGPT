...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        output = self.proj_dropout(self.fc_out(context))
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, embedding_dim, num_heads, max_sequence_length, hidden_dim, dropout=0.1):
        ...
        self.attention = MultiHeadAttention(embedding_dim, num_heads, max_sequence_length, dropout)
        self.norm1 = nn.LayerNorm(embedding_dim)
        
        self.ffn = FeedForward(embedding_dim, hidden_dim, dropout)
...
class TinyGPT(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            TransformerBlock(embedding_dim, num_heads, max_sequence_length, hidden_dim, dropout)
    ...
    def forward(self, tokens):
        ...
        assert seq_len <= self.max_sequence_length, f"Seq len {seq_len} exceeds max {self.max_sequence_length}"
